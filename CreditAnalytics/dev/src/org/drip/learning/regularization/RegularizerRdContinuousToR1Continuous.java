...
public class RegularizerRdContinuousToR1Continuous extends
		...
		throws java.lang.Exception
	{
		if (null == aadblInstance)
			throw new java.lang.Exception ("RegularizerRdContinuousToR1Continuous::loss => Invalid Inputs");
		...
		for (int i = 0; i < iNumSample; ++i)
			dblLoss += java.lang.Math.pow (java.lang.Math.abs (funcRdToR1.evaluate (aadblInstance[i])),
				iPNorm);
