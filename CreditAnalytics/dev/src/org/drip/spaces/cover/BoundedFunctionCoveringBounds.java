...
/**
 * BoundedFunctionCoveringBounds implements the Lower/Upper Bounds for the Class of Non-decreasing Functions
 *  that are:
 * 	- Absolutely Bounded
...
public class BoundedFunctionCoveringBounds implements org.drip.spaces.cover.FunctionClassCoveringBounds {
	...
	/**
	 * BoundedFunctionCoveringBounds Constructor
	 * 
	...
	public BoundedFunctionCoveringBounds (
		...
		throws java.lang.Exception
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (_dblSupport = dblSupport) || 0. >= _dblSupport ||
			...
			throw new java.lang.Exception ("BoundedFunctionCoveringBounds ctr: Invalid Inputs");
		...
		throws java.lang.Exception
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (dblCover) || 0. == dblCover)
			throw new java.lang.Exception ("BoundedFunctionCoveringBounds::logLowerBound => Invalid Inputs");
		...
		throws java.lang.Exception
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (dblCover))
			throw new java.lang.Exception ("BoundedFunctionCoveringBounds::logUpperBound => Invalid Inputs");
